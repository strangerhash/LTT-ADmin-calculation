    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
                ...
                <li><a href="{{ route('funddeposit') }}">Incoming Fund Deposit</a></li>

                <li><a href="{{ route('transactions.create') }}">Add Transaction</a></li>

                <li><a href="{{ route('withdrawal') }}">Withdrawal Requests</a></li>

                <li><a href="{{ route('outgoing.funds') }}">Outgoing Funds</a></li>
         ...
         <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
              ...
              <li><a href="{{ route('vitalvaribales') }}">Vital Variables</a></li>
...
{{--
        ...
        <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
                ...
                <li><a href="tables-datatable.html">Salary adjustment</a></li>

                <li><a href="tables-basic.html">Process</a></li>

                <li><a href="tables-responsive.html">Payroll history</a></li>

                <li><a href="tables-editable.html">Annual salary statement</a></li>

                <li><a href="tables-editable.html">Training</a></li>
