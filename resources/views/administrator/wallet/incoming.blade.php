                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0" id="incoming_funds">
                                    <thead>
                                    ...
                                    <tbody>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                @if ((int)$record->verified == 0 && $record->file_name != '')
                                                                    <a class="dropdown-item" target="_blank" href="{{ asset('storage/app/public/payments/' . $record->file_name) }}">View PoP</a>
                                        ...
                                        @empty
                                            <tr>
                                                <th colspan="7" class="text-center">No incoming funds</th>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
