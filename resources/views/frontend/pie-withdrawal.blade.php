        ...
        <!-- Container -->
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="credit-card"></i></span></span>PIE Withdrawal</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hk-row">
                                @if (Route::current()->uri == "pie/withdrawal")
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-header card-header-action">
                                            <h6>Request Withdrawal from PIE Purse</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="user-activity user-activity-sm">
                                                <form method="POST" action="{{ url('/pie/withdrawal') }}">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label>Amount</label>
                                                        <input type="text" name="amount" value="0.0" class="form-control" placeholder="Enter Amount">
                            ...
                            @else
                                <div class="col-lg-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="user-activity user-activity-sm">
                                                <form method="POST" action="{{ url('/pie-to-purse/withdrawal') }}">
                                                    @csrf
                                                    <div class="form-group">
